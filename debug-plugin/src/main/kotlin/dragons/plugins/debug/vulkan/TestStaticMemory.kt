            ...
            for (queueFamily in agent.queueManager.allQueueFamilies) {
                ...
                agent.claims.images.add(
                    ImageMemoryClaim(
                        ...
                        tiling = VK_IMAGE_TILING_OPTIMAL, samples = VK_SAMPLE_COUNT_4_BIT,
                        ...
                        storeResult = prefilledColorResult
                    ) { byteBuffer ->
                ...
                agent.claims.images.add(
                    ImageMemoryClaim(
                        ...
                        imageUsage = VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, initialLayout = VK_IMAGE_LAYOUT_DEPTH_STENCIL_ATTACHMENT_OPTIMAL,
                        accessMask = VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_READ_BIT, aspectMask = VK_IMAGE_ASPECT_DEPTH_BIT,
                ...
                agent.claims.images.add(
                    ImageMemoryClaim(
                        width = 10, height = 11, queueFamily = queueFamily,
                        bytesPerPixel = 4, imageFormat = VK_FORMAT_R8G8B8A8_SRGB,
                        tiling = VK_IMAGE_TILING_OPTIMAL, samples = VK_SAMPLE_COUNT_1_BIT,
                        imageUsage = VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, initialLayout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL,
                        accessMask = VK_ACCESS_SHADER_READ_BIT, aspectMask = VK_IMAGE_ASPECT_COLOR_BIT,
                        storeResult = uninitializedColorResult, prefill = null
                    )
                )
                ...
                agent.claims.images.add(
                    ImageMemoryClaim(
                        ...
                        imageUsage = VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT, initialLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
                        accessMask = VK_ACCESS_SHADER_READ_BIT, aspectMask = VK_IMAGE_ASPECT_DEPTH_BIT,
                        storeResult = uninitializedDepthResult, prefill = null
                    )
                )
