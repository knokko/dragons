...
internal class StandardEntityRenderer(
    ...
    init {
        ...
        this.dynamicDescriptorPool = createBasicDynamicDescriptorPool(graphicsState.boiler.vkDevice(), 1)
        ...
        stackPush().use { stack ->
            ...
            assertVkSuccess(
                vkAllocateDescriptorSets(graphicsState.boiler.vkDevice(), aiDescriptorSet, pDescriptorSet),
        ...
        stackPush().use { stack ->
            ...
            if (copyRanges.isNotEmpty()) {
                ...
                updateBasicDynamicDescriptorSet(
                    this.graphicsState.boiler.vkDevice(), this.dynamicDescriptorSet,
    ...
    fun destroy() {
        ...
        vkDestroyDescriptorPool(this.graphicsState.boiler.vkDevice(), this.dynamicDescriptorPool, null)
    }
}
